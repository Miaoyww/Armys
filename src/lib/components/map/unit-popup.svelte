...
<div class="min-w-56 py-1 font-sans">
	...
	<div class="flex items-center gap-3 pb-2">
		...
		<div class="min-w-0 flex-1">
			...
			<p class="mt-0.5 text-[10px] font-medium text-stone-400">
	...
	<!-- ── HP & 组织度 ── -->
	<div class="flex flex-col gap-1.5 rounded-md bg-stone-50 px-2 py-2">
		<!-- HP -->
		<div class="flex items-center gap-2">
			<Heart class="h-3.5 w-3.5 flex-shrink-0 text-rose-500" />
		...
		<!-- 组织度 -->
		<div class="flex items-center gap-2">
			<Zap class="h-3.5 w-3.5 flex-shrink-0 text-amber-500" />
			<div class="flex flex-1 flex-col gap-0.5">
				<div class="flex items-center justify-between">
				...
				<div class="h-1.5 w-full overflow-hidden rounded-full bg-stone-200">
					<div
						class="h-1.5 rounded-full bg-amber-400 transition-all"
						style="width:{orgPct}%;"
					></div>
				</div>
			</div>
	...
	<div class="grid grid-cols-2 gap-x-3 gap-y-1.5">
		<div class="flex items-center gap-1.5">
			...
			<span class="text-[10px] text-stone-400">软攻击</span>
			<span class="ml-auto font-mono text-[10px] font-semibold text-stone-700"
				>{placed.softAttack}</span
			>
		</div>
		<div class="flex items-center gap-1.5">
			<Wrench class="h-3 w-3 flex-shrink-0 text-zinc-500" />
			<span class="text-[10px] text-stone-400">硬攻击</span>
			<span class="ml-auto font-mono text-[10px] font-semibold text-stone-700"
		...
		<div class="flex items-center gap-1.5">
			...
			<span class="text-[10px] text-stone-400">空攻击</span>
			<span class="ml-auto font-mono text-[10px] font-semibold text-stone-700"
		...
		<div class="flex items-center gap-1.5">
			...
			<span class="text-[10px] text-stone-400">防御</span>
			<span class="ml-auto font-mono text-[10px] font-semibold text-stone-700"
				>{placed.defense}</span
			>
		</div>
		<div class="col-span-2 flex items-center gap-1.5">
			...
			<span class="text-[10px] text-stone-400">速度</span>
			<span class="ml-auto font-mono text-[10px] font-semibold text-stone-700"
